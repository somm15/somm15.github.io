...
I used it as well to store my ssh keys (see: [yubikey-SSH_PIV](https://developers.yubico.com/PIV/Guides/SSH_user_certificates.html)  and [yubiket-SSH_PIV2](https://developers.yubico.com/PIV/Guides/SSH_with_PIV_and_PKCS11.html)). However, I always faced the following problem:
{% highlight bash %}
